...
namespace ModernWpf.Metro.Controls
{
    ...
    public class AppButton : ToggleButton
    {
        ...
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register("Orientation", typeof(Orientation), typeof(AppButton), new FrameworkPropertyMetadata(Orientation.Vertical));
        ...
        public static readonly DependencyProperty ButtonSizeProperty =
            DependencyProperty.Register("ButtonSize", typeof(AppButtonSize), typeof(AppButton), new FrameworkPropertyMetadata(AppButtonSize.Large));
        ...
        public static readonly DependencyProperty TextSizeProperty =
            DependencyProperty.Register("TextSize", typeof(AppButtonSize), typeof(AppButton), new FrameworkPropertyMetadata(AppButtonSize.Small));
        ...
        public static readonly DependencyProperty TextProperty =
            DependencyProperty.Register("Text", typeof(string), typeof(AppButton), new FrameworkPropertyMetadata(null));
        ...
        public static readonly DependencyProperty CollapseOnDisableProperty =
            DependencyProperty.Register("CollapseOnDisable", typeof(bool), typeof(AppButton), new FrameworkPropertyMetadata(true));
