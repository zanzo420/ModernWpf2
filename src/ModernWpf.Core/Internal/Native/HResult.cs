...
{
    // modified from http://www.pinvoke.net/default.aspx/Enums/HRESULT.html

    [StructLayout(LayoutKind.Sequential)]
    struct HRESULT : System.IComparable,
        ...
        System.IComparable<int>
    {
        ...
        {
            if (This._value == S_OK) return true;
            if (This._value > 0) return false;
            throw GetExceptionForHR(This._value);
        }
        /// <summary>
        ...
        {
            return (this._value < that._value) ? -1 : (this._value > that._value) ? +1 : 0;
        }
        public int CompareTo(int that)
        {
            return (this._value < that) ? -1 : (this._value > that) ? +1 : 0;
        }
        #endregion
        ...
        {
            public DirCodes()
                : base(System.Collections.Generic.EqualityComparer<int>.Default)
            {
            }
            public DirCodes(int capacity)
                : base(capacity, System.Collections.Generic.EqualityComparer<int>.Default)
            {
            }
        }

        static readonly DirCodes __dirCodes = InitDirCodes();
    ...
    //{
    //    /// <summary>
    //    /// Operation successful in unexpected way.
    //    /// </summary>
    //    S_FALSE = 0x0001,
    //    /// <summary>
